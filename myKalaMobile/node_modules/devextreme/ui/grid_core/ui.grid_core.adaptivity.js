...
var AdaptiveColumnsController = modules.ViewController.inherit({
    ...
    getVisibleContentColumns: function(visibleColumns, hiddenColumns) {
        return visibleColumns.filter(function(item) {
            return !item.command && (!hiddenColumns || 0 === hiddenColumns.filter(function(column) {
                ...
                getContextMenuItems: function(options) {
                    if (options.row && "detailAdaptive" === options.row.rowType) {
                        var view = this.component.getView("columnHeadersView"),
                            formItem = $(options.targetElement).closest(".dx-field-item-label").next().data("dx-form-item");
