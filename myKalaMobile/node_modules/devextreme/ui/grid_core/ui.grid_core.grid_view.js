    ...
    _correctColumnWidths: function(resultWidths, visibleColumns) {
        ...
        if (!hasAutoWidth && resultWidths.length) {
            ...
            if (totalWidth < contentWidth) {
                ...
                while (lastColumnIndex >= 0 && visibleColumns[lastColumnIndex] && (visibleColumns[lastColumnIndex].command || resultWidths[lastColumnIndex] === HIDDEN_COLUMNS_WIDTH || false === visibleColumns[lastColumnIndex].allowResizing)) {
                    lastColumnIndex--
                }
