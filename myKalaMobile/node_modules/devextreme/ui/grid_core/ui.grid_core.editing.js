...
var EditingController = modules.ViewController.inherit(function() {
    ...
    return {
        ...
        _handleDataChanged: function(args) {
            ...
            if ("refresh" === args.changeType && getEditMode(that) === EDIT_MODE_POPUP && editForm && editForm.option("visible")) {
                editForm.repaint()
            }
        },
        ...
        _createLink: function(container, text, methodName, options, linkClass) {
            var that = this,
                $link = $("<a>").attr("href", "#").addClass(LINK_CLASS).addClass(linkClass).text(text);
